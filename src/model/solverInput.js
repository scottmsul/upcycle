...
import { OUTPUT_ITEMS_KEY, MAX_QUALITY_UNLOCKED_KEY, ALLOW_BYPRODUCTS_KEY, QUALITY_MODULE_TIER_KEY, QUALITY_MODULE_QUALITY_KEY, QUALITY_MODULE_COST_KEY, PROD_MODULE_TIER_KEY, PROD_MODULE_QUALITY_KEY, PROD_MODULE_COST_KEY, CHECK_SPEED_BEACONS_KEY, BEACONED_SPEED_MODULE_TIER_KEY as BEACONED_SPEED_MODULE_TIER_KEY, BEACONED_SPEED_MODULE_QUALITY_KEY as BEACONED_SPEED_MODULE_QUALITY_KEY, BEACON_QUALITY_KEY as BEACON_QUALITY_KEY, MAX_BEACONED_SPEED_MODULES_KEY, PRODUCTIVITY_RESEARCH_KEY, PLANETS_KEY, RESOURCES_KEY, INPUT_ITEMS_KEY, DEFAULT_OUTPUT_ITEMS, DEFAULT_MAX_QUALITY_UNLOCKED, DEFAULT_CRAFTING_MACHINE_QUALITY, DEFAULT_CRAFTING_MACHINE_COST, DEFAULT_ALLOW_BYPRODUCTS, DEFAULT_QUALITY_MODULE_TIER, DEFAULT_QUALITY_MODULE_QUALITY, DEFAULT_QUALITY_MODULE_COST, DEFAULT_PROD_MODULE_TIER, DEFAULT_PROD_MODULE_QUALITY, DEFAULT_PROD_MODULE_COST, DEFAULT_CHECK_SPEED_BEACONS, DEFAULT_BEACONED_SPEED_MODULE_TIER as DEFAULT_BEACONED_SPEED_MODULE_TIER, DEFAULT_BEACONED_SPEED_MODULE_QUALITY as DEFAULT_BEACONED_SPEED_MODULE_QUALITY, DEFAULT_BEACON_QUALITY as DEFAULT_BEACON_QUALITY, DEFAULT_MAX_BEACONED_SPEED_MODULES, DEFAULT_PRODUCTIVITY_RESEARCH, DEFAULT_PLANETS, DEFAULT_RESOURCES, WHITELIST_RECIPES_KEY, DEFAULT_WHITELIST_RECIPES, RECIPES_KEY, DEFAULT_RECIPES, CRAFTING_MACHINES_KEY, DEFAULT_CRAFTING_MACHINES, ALL_SOLVER_INPUT_KEYS, SPEED_MODULE_TIER_KEY, DEFAULT_SPEED_MODULE_TIER, SPEED_MODULE_QUALITY_KEY, DEFAULT_SPEED_MODULE_QUALITY, SPEED_MODULE_COST_KEY, DEFAULT_SPEED_MODULE_COST } from './constants.js';
...
export class SolverInput {
    ...
    initialize_values() {
        ...
        this.speed_module_cost = getLocalStorageFloat(SPEED_MODULE_COST_KEY, DEFAULT_SPEED_MODULE_COST);

        this.check_speed_beacons = getLocalStorageBoolean(CHECK_SPEED_BEACONS_KEY, DEFAULT_CHECK_SPEED_BEACONS);
        this.beaconed_speed_module_tier = getLocalStorageInt(BEACONED_SPEED_MODULE_TIER_KEY, 0, 2, DEFAULT_BEACONED_SPEED_MODULE_TIER);
        this.beaconed_speed_module_quality = getLocalStorageInt(BEACONED_SPEED_MODULE_QUALITY_KEY, 0, 4, DEFAULT_BEACONED_SPEED_MODULE_QUALITY);
        this.beacon_quality = getLocalStorageInt(BEACON_QUALITY_KEY, 0, 4, DEFAULT_BEACON_QUALITY);
