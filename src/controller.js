...
import { ADD_INPUT_ITEM_BUTTON_ID, ADD_OUTPUT_ITEM_BUTTON_ID, ADD_RECIPE_BUTTON_ID, ALLOW_BYPRODUCTS_INPUT_ID, BEACON_QUALITY_SELECT_ID, BLACKLIST_RECIPES_INPUT_ID, CHECK_SPEED_BEACONS_INPUT_ID, CRAFTING_MACHINE_COST_INPUT_ID, CRAFTING_MACHINE_QUALITY_SELECT_ID, INPUT_ITEMS_TABLE_ID, MAX_BEACONED_SPEED_MODULES_INPUT_ID, MAX_QUALITY_UNLOCKED_SELECT_ID, OUTPUT_ITEMS_TABLE_ID, PLANETS_TABLE_ID, PROD_MODULE_COST_INPUT_ID, PROD_MODULE_QUALITY_SELECT_ID, PROD_MODULE_TIER_SELECT_ID, PRODUCTIVITY_RESEARCH_TABLE_ID, QUALITY_MODULE_COST_INPUT_ID, QUALITY_MODULE_QUALITY_SELECT_ID, QUALITY_MODULE_TIER_SELECT_ID, RECIPES_TABLE_ID, RESOURCES_TABLE_ID, SPEED_MODULE_QUALITY_SELECT_ID, SPEED_MODULE_TIER_SELECT_ID, WHITELIST_RECIPES_INPUT_ID } from "./ui/constants.js";
