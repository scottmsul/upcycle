...
export class Controller {
    constructor() {
        ...
        window.document.getElementById(RESTORE_DEFAULTS_BUTTON_ID).onclick = (() => {
            localStorage.clear();
            this.solver_input.initialize_values();
            display_solver_input(this.solver_input);
        });
