import { INPUT_ITEMS_TABLE_ID, OUTPUT_ITEMS_TABLE_ID, PROD_MODULE_TIER_SELECT_ID, PROD_MODULE_QUALITY_SELECT_ID, QUALITY_MODULE_TIER_SELECT_ID, QUALITY_MODULE_QUALITY_SELECT_ID, QUALITY_MODULE_COST_INPUT_ID, PROD_MODULE_COST_INPUT_ID } from "./ui/constants.js";
...
export class Preferences {
    constructor(parsed_data) {
        ...
        this.quality_module_cost = window.document.getElementById(QUALITY_MODULE_COST_INPUT_ID).value;
        ...
        this.prod_module_cost = window.document.getElementById(PROD_MODULE_COST_INPUT_ID).value;
